...
*   **SEO 优化着陆页**：包含 Hero Section、功能介绍与 SEO Metadata 的营销主页。
...
│   │   ├── generate/  # [NEW] 应用主生成页面
│   │   ├── history/   # 历史记录页面
│   │   └── page.tsx   # [UPDATED] 着陆页 (Landing Page)
│   ├── components/    # UI 组件
│   ├── lib/           # 工具函数 (DB, Bilibili, Utils)
│   └── middleware.ts  # [RENAMED] 路由保护代理
├── public/
└── ...
```
